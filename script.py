...
#     # Staff Costs (dynamic based on patients and ratios)
#     staff_required = max(1, (stats['processed'] + stats['reneged']) // 5)
#     base_staff_cost = STAFF_COST_BASE * staff_required * operational_hours
#     overtime_staff_cost = STAFF_COST_OVERTIME * max(0, (stats['arrivals'] - stats['processed']) / 5)
...
#     # Utilization
#     holding_bay_utilization = (stats['holding_bay_usage'] / (SIM_TIME * num_holding_bays)) * 100

#     return revenue, holding_bay_cost, cancellation_cost, base_staff_cost, overtime_staff_cost, total_cost, profit, holding_bay_utilization
...
#     plt.ylabel('Profit ($)')
#     plt.tight_layout()
#     plt.savefig(os.path.join(output_directory, 'profit_vs_holding_bays.png'))
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(os.path.join(output_directory, 'cost_breakdown_by_holding_bays.png'))
#     plt.close()

#     # Overcapacity Instances
#     plt.figure(figsize=(10, 6))
#     sns.barplot(data=results_df, x='Holding Bays', y='Overcapacity Instances', hue='Closing Time')
#     plt.title('Overcapacity Instances by Holding Bays and Closing Time')
#     plt.tight_layout()
#     plt.savefig(os.path.join(output_directory, 'overcapacity_instances.png'))
#     plt.close()

#     # Holding Bay Utilization
#     plt.figure(figsize=(10, 6))
#     sns.lineplot(data=results_df, x='Holding Bays', y='Holding Bay Utilization (%)', hue='Closing Time')
#     plt.title('Holding Bay Utilization by Holding Bays and Closing Time')
#     plt.tight_layout()
#     plt.savefig(os.path.join(output_directory, 'holding_bay_utilization.png'))
#     plt.close()
...
#             'holding_bay_usage': 0,
#             'cancellation_reasons': {'overcapacity': 0, 'closed_bays': 0}
#         }
...
#         hospital.stats['cancellation_reasons']['closed_bays'] += 1
#         return
...
#             hospital.stats['holding_bay_usage'] += preparation_time
...
#             hospital.stats['overcapacity_instances'] += 1
...
#         revenue, holding_bay_cost, cancellation_cost, base_staff_cost, overtime_staff_cost, total_cost, profit, holding_bay_utilization = calculate_costs_and_profit(stats, num_bays, closing)
...
#             'Overcapacity Instances': stats['overcapacity_instances'],
#             'Revenue': revenue,
...
#             'Profit': profit,
#             'Holding Bay Utilization (%)': holding_bay_utilization,
#         })
...
#         print(f"Overcapacity Instances: {stats['overcapacity_instances']}")
...
#         print(f"Holding Bay Utilization: {holding_bay_utilization:.2f}%")
#         print("-" * 50)
...
# optimal_config = results_df.loc[results_df['Profit'].idxmax()]
